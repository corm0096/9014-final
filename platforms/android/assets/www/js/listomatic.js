...
function main()
{
	...
	save_button=document.getElementById("bouton");
	addition=document.getElementById("item_entry");
	
	current_list=JSON.parse(localStorage.getItem("grocery-corm0096"));
...
function display_items()
{
	...
	{		
		for (var work=0;work<current_list.length;work++)
		{
			...
			if (current_list[work].done)
			{
				check_content+=" checked>";
			}
			else
			{
				check_content+=">";
...
function process_click()
{
	...
	if (!empty) //Delete rows marked for deletion
	{
